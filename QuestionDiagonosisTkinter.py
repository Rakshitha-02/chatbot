...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="PeachPuff2", width="500", height="3", font=("Calibri", 14))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Made by:", bg="yellow", width = "250", height = "1", font=("Calibri", 15))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Rakshitha R", bg="RoyalBlue1", width = "250", height = "1", font=("Stylus", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Preeti B M", bg="RoyalBlue2", width = "250", height = "1", font=("Stylus", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Guna shree", bg="RoyalBlue3", width = "250", height = "1", font=("Stylus", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="Shreedevi R", bg="RoyalBlue1", width = "250", height = "1", font=("Stylus", 13))
        self.lblTeam4.pack()
        self.lblTeam5=Label(self, text="Sirisha", bg="RoyalBlue3", width = "250", height = "1", font=("Stylus", 13))
        self.lblTeam5.pack()
